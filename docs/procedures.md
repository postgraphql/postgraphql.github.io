...
<div class="container new-discussion-timeline experiment-repo-nav">
  ...
  <!-- blob contrib key: blob_contributors:v21:2d199d61658cd869bc2223404c1d98e9 -->
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/postgraphql/postgraphql/tree/v1.9.1/docs/procedures.md"
              data-name="v1.9.1"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/postgraphql/postgraphql/tree/v1.2.1/docs/procedures.md"
              data-name="v1.2.1"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
...
<span class="pl-k">create</span> <span class="pl-k">function</span> <span class="pl-en">my_function</span>(a <span class="pl-k">int</span>, b <span class="pl-k">int</span>) returns setof person <span class="pl-k">as</span> $$ … $$ language sql;</pre></div>
...
<div class="highlight highlight-source-sql"><pre><span class="pl-k">create</span> <span class="pl-k">function</span> <span class="pl-en">person_full_name</span>(person person) returns <span class="pl-k">text</span> <span class="pl-k">as</span> $$
  <span class="pl-k">select</span> <span class="pl-c1">person</span>.<span class="pl-c1">given_name</span> <span class="pl-k">||</span> <span class="pl-s"><span class="pl-pds">'</span> <span class="pl-pds">'</span></span> <span class="pl-k">||</span> <span class="pl-c1">person</span>.<span class="pl-c1">family_name</span>
$$ language sql stable;</pre></div>
<p>Will create a computed column for your table named <code>person</code>.</p>
<p>To query these in the PostGraphQL schema, its pretty intuitive:</p>
<div class="highlight highlight-source-graphql"><pre>{
  <span class="pl-v">person</span>(<span class="pl-v">id</span>: …) {
    <span class="pl-v">givenName</span>
    <span class="pl-v">familyName</span>
    <span class="pl-v">fullName</span><span class="pl-c"> # A computed column, but the client doesn’t even know!</span>
    <span class="pl-v">myFunction</span>(<span class="pl-v">a</span>: <span class="pl-c1">1</span>, <span class="pl-v">b</span>: <span class="pl-c1">2</span>)<span class="pl-c"> # A computed column with arguments.</span>
  }
}</pre></div>
<hr>
<p>For ideas on how to use procedures in PostGraphQL, remember to check out the <a href="https://github.com/calebmer/postgraphql/blob/master/examples/forum/schema.sql">forum example SQL schema</a>!</p>
</article>
  </div>
...
<div class="container site-footer-container">
  <div class="site-footer " role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2017 <span title="0.14383s from unicorn-426496520-60pzt">GitHub</span>, Inc.</li>
